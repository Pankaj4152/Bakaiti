  ...
  return (
    <ChatWallpaperWrapper conversationId={conversationId}>
      <div className={`flex flex-col h-full ${themeClass}`}>
        <div className="sticky top-0 z-30 flex items-center gap-1 px-2 h-14 border-b border-white/10 bg-black/40 backdrop-blur-xl flex-shrink-0 min-w-0 shadow-sm">
          <MobileMenuButton />
